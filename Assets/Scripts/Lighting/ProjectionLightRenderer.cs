...
public class ProjectionLightSystem
{
	...
	static public ProjectionLightSystem instance {
		get {
			if (m_Instance == null)
				m_Instance = new ProjectionLightSystem();
			return m_Instance;
		}
	}

	internal HashSet<ProjectionLight> m_Lights = new HashSet<ProjectionLight>();
...
[ExecuteInEditMode]
public class ProjectionLightRenderer : MonoBehaviour
{
	...
	public void OnWillRenderObject()
	{
		...
		var system = ProjectionLightSystem.instance;
		...
		foreach (var o in system.m_Lights)
		{
			...
			if (o.m_Kind == ProjectionLight.Kind.Sphere)
			{
			...
			else if (o.m_Kind == ProjectionLight.Kind.Tube)
			{
